...
import com.aliyun.apsaravideo.recorder.view.focus.SeekWrapperLayout;
...
//        intent.putExtra(AliyunConfig.KEY_FROM, getIntent().getStringExtra(AliyunConfig.KEY_FROM));
    ...
    private void startRecording() {
        ...
        String videoPath = Constants.SDCardConstants.OUTPUT_PATH_DIR + System.currentTimeMillis() + ".mp4";
